...
const ImageInputTypeSchema = z.enum(["URL", "UPLOAD", "GENERATED"]);

export type ImageInputType = z.infer<typeof ImageInputTypeSchema>;
...
export const ContentImageSchema = z.object({
  ...
  source: ImageSourceSchema.default(DEFAULT_IMAGE_SOURCE),
  style: ContentImageStyleSchema.default({ opacity: 100, objectFit: "Cover" }),
});
